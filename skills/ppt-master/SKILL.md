...
- Spec planning retries are enabled by default: `PPT_MASTER_SPEC_RETRIES=10` retries the whole `design_plan/spec_lock` provider request when marker pairs are missing or JSON is invalid. Do not salvage corrupted spec content; regenerate it.
