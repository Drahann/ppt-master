...
def download_and_rewrite_markdown_images(markdown: str, project_path: Path) -> tuple[str, list[ImageAsset]]:
    """Download HTTP(S) Markdown images and replace source URLs with local assets."""
