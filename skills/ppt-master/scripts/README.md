...
The runner uses staged Qwen sessions with deterministic precomputed references, batched serial SVG generation for long decks, a separate design-spec review gate, async C7 pie/donut SVG review gates launched as batches finish, a dedicated notes stage, and deterministic SVG quality-check plus title/syntax auto-repair scripts before export.
