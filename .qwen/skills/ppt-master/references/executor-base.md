...
> 🚧 **GATE - Must read visual cookbook before first SVG page**
>
> After confirming the design parameters and before generating the first SVG page, you **must read** `svg_design_cookbook.md`.
>
> Use it as the mandatory visual-execution reference for:
> - page aesthetics and hierarchy
> - card treatment and spacing rhythm
> - SVG code style and composition quality
>
> The cookbook complements this file, the selected `executor-{style}.md`, and `shared-standards.md`. It does not override the Design Specification.

> 🚧 **GATE - Must lock runtime anchors before first SVG page**
>
> If a runtime file such as `runner/svg_anchor_context.json` is present, you **must read it** after the cookbook and before generating the first SVG page.
>
> Treat it as the immutable execution anchor for:
> - fixed header / title / icon / footer geometry
> - canonical `defs` IDs and shadow implementation
> - exact SVG filenames and notes headings from the slide plan
> - re-anchor checkpoints during long sequential generation
